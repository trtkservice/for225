...
def load_and_merge_data():
    ...
    for f in files:
        ...
        # We need to inspect columns manually or assume standard format.
        # Let's clean the columns after loading.
        try:
    ...
    # Needs columns: Date, Open, High, Low, Close
    # Let's standardize column names
    # Possible variations: '日付', '時刻', '始値', ... or 'Date', 'Time', 'Open'...
